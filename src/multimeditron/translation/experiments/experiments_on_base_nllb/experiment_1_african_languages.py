...
Output: src/multimeditron/translation/experiments/results/base_nllb/experiment_1_results.json
"""
...
class TranslationEvaluator:
    ...
    def compute_metrics(self):
        ...
        for pipeline in ['meditron_direct', 'nllb']:
            stats[pipeline] = {}
    ...
    def print_summary(self):
        """Print comparison of Meditron vs NLLB translation quality."""
        ...
        print("="*70)
        print(f"\n{'Language':<12} {'Meditron Direct':<30} {'NLLB + fastText':<30} {'Winner':<10}")
        ...
        if abs(chrf_diff) < 3:
            ...
            if det_acc > 85:
                ...
                print(f"   → Use fastText → NLLB → Meditron pipeline")
            else:
    ...
    def save_results(self, output_path: str):
        ...
        output = {
            'experiment': 'African Languages: Translation Comparison',
            'detection_stats': {
...
def run_experiment(args):
    ...
    print("(TWO-PASS VERSION - Meditron first, then NLLB)")
    print("="*70)
    ...
    print(f"\n   Running NLLB translations on {len(meditron_results)} samples...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="African languages translation experiment: Meditron vs NLLB"
    )
    parser.add_argument(
        "--max_samples",
        type=int,
